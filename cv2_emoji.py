...
def load_emoji():
    smile_emoji = cv2.imread('C:/Users/skh01/Downloads/smile.png', cv2.IMREAD_UNCHANGED)
    ...
    # 이모티콘 이미지 읽기
    neutral_emoji = cv2.imread('C:/Users/skh01/Downloads/neutral.png', cv2.IMREAD_UNCHANGED)
...
def model_load():
    ...
    model.load_state_dict(torch.load("C:/Users/skh01/바탕 화면/best_model_0516_vgg16_73.2.pt", map_location=torch.device('cpu')))
    return model
...
def webcam():
    ...
    #얼굴 인식 캐스케이드 파일 읽는다
    face_cascade = cv2.CascadeClassifier('C:/Users/skh01/Downloads/haarcascade_frontalface_alt.xml')
    count = 0
